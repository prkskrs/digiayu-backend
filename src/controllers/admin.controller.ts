...
export default class AdminControllers {
    ...
    public getPatientDetails = async (req: Request, res: Response) => {
        try {
            ...
            const appointments = await this.database.get(Constants.COLLECTIONS.APPOINTMENT, condition);
    ...
    public getAppointmentDetails = async (req: Request, res: Response) => {
        try {
            ...
            const appointment = await this.database.aggregate('appointment', pipeline);
