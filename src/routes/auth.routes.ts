...
router.post(
  ...
  RequestValidator(requestSchemas.authRoutesSchemas.signupDoctor.headers, 'headers'),
...
router.post(
  ...
  RequestValidator(requestSchemas.authRoutesSchemas.signupPatient.headers, 'headers'),
...
router.post('/upload/:fieldName/:userId', upload('file'), authControllers.uploadAvatar);
