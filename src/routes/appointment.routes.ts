...
router.post(
  "/book",
  RequestValidator(
    requestSchemas.appointmentRoutesSchemas.bookAppointment.body,
    "body",
  ),
  RequestValidator(
    requestSchemas.appointmentRoutesSchemas.bookAppointment.headers,
    "headers",
  ),
  appointmentControllers.bookAppointment,
);

router.get("/zoom/auth", appointmentControllers.zoomAuthorization);
...
router.get(
  "/",
  RequestValidator(
    requestSchemas.appointmentRoutesSchemas.getAppointments.headers,
    "headers",
  ),
...
router.patch(
  "/:id",
  RequestValidator(
    requestSchemas.appointmentRoutesSchemas.updateAppointment.body,
    "body",
  ),
  RequestValidator(
    requestSchemas.appointmentRoutesSchemas.updateAppointment.headers,
    "headers",
  ),
