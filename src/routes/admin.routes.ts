...
router.get(
    "/doctors",
    RequestValidator(requestSchemas.adminRoutesSchemas.getDoctors.headers, "headers"),
    adminControllers.getAllDoctors
);

router.get(
    "/patients",
    RequestValidator(requestSchemas.adminRoutesSchemas.getPatients.headers, "headers"),
    adminControllers.getAllPatients
);

router.get(
    "/appointments",
    RequestValidator(requestSchemas.adminRoutesSchemas.getAppointments.headers, "headers"),
