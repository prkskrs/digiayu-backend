...
let ProductControllers = class ProductControllers {
    constructor() {
        this.create = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const productNew = {
                ...
                sub_category_id: new mongodb_1.ObjectId(sub_category_id),
            ...
            const product = yield this.database.add(Constants_1.default.COLLECTIONS.PRODUCT, Object.assign({}, productNew));
        ...
        this.list = (req, res) => __awaiter(this, void 0, void 0, function* () {
            const count = yield this.database.getCount(Constants_1.default.COLLECTIONS.PRODUCT, {
                status: 'available',
            });
            ...
            const products = yield this.database.get(Constants_1.default.COLLECTIONS.PRODUCT, {
                status: 'available',
...
], ProductControllers.prototype, "database", void 0);
ProductControllers = __decorate([
    (0, typedi_1.Service)()
], ProductControllers);
